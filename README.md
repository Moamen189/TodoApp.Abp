...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p ce3176fe-34dd-42e1-9ef6-5c7e1ae71708
```

> `ce3176fe-34dd-42e1-9ef6-5c7e1ae71708` is the password of the certificate, you can change it to any password you want.
